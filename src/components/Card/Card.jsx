...
export default function Card(props){
    return(
      ...
      <div class="outer-card" style={{padding:"2rem"}}>
        <div class="card" style={{width: "18rem", padding:"0.2rem"}}>
        ...
        <div class="card-body" style={{padding:"0.5rem"}}>
          ...
          <div class="card-footer" style={{backgroundColor:"white"}}> 
            {props.channel.tags.map((tag) => (
              <button style={{padding:"0.5rem", color:"white", backgroundColor:"#282828"}} type="button" class="btn btn-sm disabled">{tag}</button>
        ))}
        </div>
